...
class RD03D:
    ...
    # default interface war: /dev/ttyAMA0 - auf dem tueroeffner habe ich aber UART2 aktiviert. Baudrate war im ersten Test 115200 - das kann aber sensorspezifisch sein und 256000 stimmen....
    def __init__(self, uart_port='/dev/ttyAMA2', baudrate=256000, multi_mode=True):
