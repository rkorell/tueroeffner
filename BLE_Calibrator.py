...
# Corrected: August 19, 2025, 16:00 UTC - Added option to disable live beacon display for performance improvement.
...
# NEU: Option zur Steuerung der Live-Anzeige der Beacons
ENABLE_LIVE_BEACON_DISPLAY = False # Setzen Sie dies auf True, um die Live-Anzeige zu aktivieren.
...
class BLECalibratorGUI:
    def __init__(self, root, loop):
        ...
        # NEU: Instanzvariable für die Live-Anzeige
        self.enable_live_display = ENABLE_LIVE_BEACON_DISPLAY
            ...
            if 0x004C in advertisement_data.manufacturer_data:
                ...
                if len(mfg_data) >= 23 and mfg_data[0] == 0x02 and mfg_data[1] == 0x15:
                    ...
                    if uuid_str == TARGET_IBEACON_UUID and major_val in self.allowed_majors:
                        ...
                        # NEU: Update GUI data listbox nur, wenn die Live-Anzeige aktiviert ist
