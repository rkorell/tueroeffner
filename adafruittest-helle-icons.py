...
def draw_display_content(draw, weather_data, status_icon_type=None):
    ...
    # This value might need fine-tuning based on the specific font and its rendering.
    # A positive value moves the text downwards. Experiment with 0, 1, 2, 3...
    # Based on common font rendering, a value of 1 or 2 often helps for visual centering.
    VERTICAL_TEXT_ALIGN_OFFSET = -3 # 
    ...
    if weather_data:
        ...
        if ICON_WIND is not None:
            wind_icon_y = 110 # Y-Position des Wind-Icons
            ...
            # FONT_WEATHER_DETAIL.getbbox('')[3] gibt die Linienhöhe der Schriftart
            text_height_for_centering = FONT_WEATHER_DETAIL.getbbox('')[3]
            # Gleitkommadivision für präzisere Zentrierung, dann in Integer umwandeln
        ...
        if ICON_RAIN is not None:
            rain_icon_y = 135 # Y-Position des Regen-Icons
