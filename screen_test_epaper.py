# Program: screen_test_epaper.py
# Purpose: Testprogramm für Waveshare e-Paper Display 2.9'' V2.
#          Angepasste Version des Waveshare-Beispiels mit festen Pfaden
#          für die Verwendung außerhalb des Original-Repository-Ordners.
...
# NEU: Absolute Pfade zu den Waveshare-Ressourcen
# Diese Pfade müssen auf die tatsächliche Installation deines Waveshare-Repositories zeigen.
# Annahme: Das Waveshare-Repository wurde nach /home/pi/e-Paper/ geklont
# und der Ordner "RaspberryPi&JetsonNano" wurde zu "RaspberryPi_JetsonNano" umbenannt.
WAVESHARE_BASE_PATH = '/home/pi/e-Paper/RaspberryPi_JetsonNano/python'
picdir = os.path.join(WAVESHARE_BASE_PATH, 'pic')
libdir = os.path.join(WAVESHARE_BASE_PATH, 'lib')

# Der Rest des Codes ist identisch zum Original-Beispiel
